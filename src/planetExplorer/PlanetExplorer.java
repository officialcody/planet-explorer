...
public class PlanetExplorer {
	...
	public static void main (String [] args) {
		...
		System.out.println("     by: Sparsh Goel");
		
		// Computes and display the periods of the specified nine solar objects in years, days, hours, 
		// minutes, and seconds		
		System.out.println();
		...
		System.out.println("My mass on Earth weighs: " + mass.format(yourMassWeightOnEarth) + " Kilograms");
		
		// The following line computes how much my mass weight would be on each of the planets
		...
		// The following statements are used to compute my weight on venus, mars, jupiter, saturn, uranus, neptune,
